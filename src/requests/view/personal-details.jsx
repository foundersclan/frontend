                                            ...
                                            <div className="bg-zinc-950/80 border border-amber-500/20 p-4 rounded-2xl flex flex-col gap-3">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-[10px] font-bold uppercase transition-colors disabled:text-zinc-600 disabled:cursor-not-allowed enabled:text-amber-500 enabled:hover:text-white"
                                                    >
