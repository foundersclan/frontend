  ...
  const handleJoinClan = () => {
    if (!token) {
      ...
      navigate("/login")
       ...
       toast.success("Please fill the Form to Join Our Clan")
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto shrink-0 flex items-center gap-2 w-auto bg-zinc-900/40" onClick={scrollToTop}>
        ...
        <NavLink to="/" className="group flex items-center gap-2 md:gap-4 bg-zinc-900/40 backdrop-blur-xl border border-white/5 p-1  md:pr-6 rounded-full transition-all hover:bg-zinc-900/80">
