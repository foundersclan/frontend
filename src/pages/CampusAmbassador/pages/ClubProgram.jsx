import { Users,Calendar,Rocket,Target,Globe,Trophy,ArrowRight,CheckCircle2,Megaphone,Briefcase ,AlertTriangle, ChevronRight,
} from "lucide-react";
import { Button } from "../components/shared/Button";

export default function ClubProgram() {
  return (
    <div className="relative min-h-screen bg-[#3720494e] text-white font-sans selection:bg-yellow-500/30 overflow-hidden px-6 py-24">
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 bg-zinc-950/50 backdrop-blur-xl border border-white/10 p-8 rounded-[32px] relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-32 h-32 bg-yellow-500/5 blur-3xl rounded-full" />

          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-yellow-500/20 bg-yellow-500/5 text-yellow-500 text-xs font-bold uppercase tracking-widest mb-6">
          ...
          {/* Quick Info Block */}
          <div className="flex flex-col gap-4 min-w-[260px] w-full md:w-auto bg-white/5 p-5 rounded-2xl border border-white/5">
            <div className="flex items-center gap-4">
              <div className="p-2.5 rounded-xl bg-purple-500/10 text-purple-400">
                <Calendar size={18} />
              </div>
              <div>
                <p className="text-[12px] text-zinc-500 uppercase font-bold tracking-wider">
        ...
        <div className="bg-gradient-to-r from-zinc-950/40 to-zinc-900/40 backdrop-blur-md border border-white/10 rounded-[24px] p-6">
          <p className="text-[12px] font-black uppercase tracking-widest text-zinc-500 mb-4">
            Eligibility Matrix
          </p>
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span
                key={idx}
                className="px-3 py-1.5 rounded-xl bg-zinc-950/60 border border-white/5 text-sm text-zinc-300 font-medium"
              >
                {el}
              </span>
            ))}
        ...
        <div className="bg-zinc-950/70 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 md:p-10 space-y-10 group relative">
          <div>
            <h2 className="text-xl md:text-2xl font-black uppercase tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-zinc-200 to-zinc-400">
              All that you need to know about Founders Igniters Club Program
              2026-27
            </h2>
            <div className="space-y-4 text-zinc-400 border-l-2 border-yellow-500/30 pl-4">
              <p className="font-bold text-white text-base">
                What is the Founders Igniters Club?
              </p>
              <p className="italic text-yellow-500 font-medium">
          ...
          <div className="pt-8 border-t border-white/5">
            <p className="font-black text-sm uppercase tracking-widest text-zinc-500 mb-2">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={idx}
                  className="p-5 rounded-2xl bg-zinc-900/30 border border-white/5 flex gap-4 items-start hover:bg-zinc-900/50 hover:border-white/10 transition-all hover:translate-x-1"
                >
                  <div className="p-2 rounded-xl bg-yellow-500/10 text-yellow-500 shrink-0 mt-0.5">
                    {item.icon}
                  </div>
                  <div>
            ...
            <div className="mt-6 p-4 rounded-xl bg-white/5 border border-white/5 text-center backdrop-blur">
              <p className="text-lg font-semibold text-zinc-400">
                Club Size: <span className="text-yellow-500">3-5 members</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-950/70 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 md:p-10 relative overflow-hidden group">
          ...
          <div className="relative border-l border-white/10 pl-6 ml-3 space-y-8">
            {[
              ...
              },
              {
                ...
                desc: "The Founders Team will select 3-5 members to become 'Founders Igniters' based on their interviews. Selected candidates will receive a confirmation email with onboarding details.",
              },
              {
                step: "Step 4",
              ...
              <div key={idx} className="relative group/step">
                <div className="absolute -left-[30px] top-1 w-2.5 h-2.5 rounded-full bg-zinc-800 border border-zinc-950 group-hover/step:bg-yellow-500 transition-colors" />
                <span className="text-[14px] font-black tracking-widest uppercase text-yellow-500/70">
                  {phase.step}
                </span>
                <h3 className="font-bold text-lg text-white mt-0.5 mb-1 tracking-tight">
                  {phase.title}
                </h3>
        ...
        <div className="bg-zinc-950/70 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 md:p-10 relative">
          <h2 className="text-xl font-black uppercase tracking-widest text-zinc-500 mb-6 flex items-center gap-2">
            <Trophy size={18} className="text-yellow-500" /> Rewards & Benefits
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div
                key={idx}
                className="flex gap-3 items-start bg-zinc-900/30 p-4 rounded-2xl border border-white/5 hover:border-white/10 transition-colors"
              >
                <CheckCircle2
                  size={20}
        ...
        <div className="bg-amber-500/5 border border-amber-500/20 rounded-[24px] p-6 flex gap-4 items-start backdrop-blur-md">
          <div className="p-2 rounded-xl bg-amber-500/10 text-amber-500 shrink-0 mt-0.5">
            <AlertTriangle size={18} />
          </div>
          <div>
            <h4 className="font-bold text-lg uppercase tracking-wider text-amber-500 mb-1">
              Important Note
            </h4>
        ...
        <div className="text-center pt-4">
          <p className="text-zinc-600 text-sm uppercase tracking-[0.2em] font-bold">
