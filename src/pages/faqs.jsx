...
export const Faqs = () => {
  const faqsData = [
    { id: 1, question: "What is the primary focus of the community?", answer: "We focus on accelerating early-stage founders by providing expert mentorship, actionable resources, and a strong peer-to-peer network." },
    { id: 2, question: "How often are the networking events held?", answer: "Networking events, both virtual and in-person, are held bi-weekly, featuring key industry speakers and investor pitch opportunities." },
    { id: 3, question: "Is there a cost to join the club?", answer: "Yes, membership is subscription-based. We offer three tiers—Starter, Pro, and Executive—tailored to different stages of startup growth." },
    ...
    { id: 5, question: "What is the typical size of a founding team in the club?", answer: "Our community primarily supports teams of 1-5 members, focusing on pre-seed and seed-stage companies." },
  ];
